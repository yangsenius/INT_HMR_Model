...
cfg.MODEL.PROJ_MODE = 'linear'
cfg.MODEL.USE_JOINT2D_HEAD = False
cfg.MODEL.USE_ROT2TOKEN_HEAD = False
cfg.MODEL.CONTRAINT_TOKEN_DELTA = False
...
cfg.MODEL.TEMPORAL_LAYERS = 3
cfg.MODEL.TEMPORAL_NUM_HEADS = 12

cfg.MODEL.LOAD_PRETRAINED_HEAD = True

cfg.MODEL.ENABLE_TEMP_MODELING = True
cfg.MODEL.ENABLE_TEMP_EMBEDDING = False
...
def parse_args():
    ...
    parser.add_argument('--pretrained', type=str,
                        help='stage 1 checkpoint file path', default='')
    ...
    parser.add_argument('--eval_set', type=str,
                        help='eval set in [test|val]', default='test')
    parser.add_argument('--image_root', type=str,
                        help='inference image root', default='')
    parser.add_argument('--image_list', type=str,
                        help='inference image list', default='')
    parser.add_argument('--output_path', type=str,
                        help='path to save the inference file generated in evaluation', default='')
    parser.add_argument('--logdir', type=str,
                        help="workdir save logs, checkpoints, best_models")
