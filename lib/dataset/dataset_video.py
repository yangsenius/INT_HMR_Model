...
class VideoDataset(Dataset):
    ...
    def __getitem__(self, index):
        ...
        #     if 'mpi_inf_3dhp' in path_name:
        #         path_name = path_name[:-10] + 'frame_' + path_name[-10:]
        #         path_name = path_name.replace('v', 'V')
        #     new_img_paths.append(path_name)
